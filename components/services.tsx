...
export function Services() {
  return (
    <section
      id="services"
      className="py-16 md:py-20 px-4 sm:px-6 lg:px-6 bg-slate-50 text-slate-900"
    >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white border border-slate-200 p-5 rounded-2xl flex flex-col justify-between space-y-4 hover:border-amber-500/50 hover:shadow-md transition-all"
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs font-semibold text-amber-600 hover:text-amber-700 pt-2 border-t border-slate-100"
                >
                  <span>Consult</span>
                  <ArrowRight size={12} />
                </a>
